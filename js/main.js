...
$(document).ready(function() {
    ...
    if ($('body').hasClass('investment')) {
        ...
        function typeJs() {
            ...
            $("#typed").typed({
                ...
                strings: ["Финансовые инструменты будущего уже <br>сейчас используют открытые блокчейн-сети, собственность имеет надежное цифровое воплощение, а все операции полностью прозрачны для инвестора."],
    ...
    if ($('body').hasClass('home-page')) {
        ...
        function typeJs() {
            ...
            $("#typed").typed({
                ...
                strings: ["Мы – команда блокчейн-энтузиастов из России, которая реализовала возможность инвестиций <br>в высокотехнологичные проекты на основе цифровой собственности и прозрачности<br> всех операций."],
                // stringsElement: $('#typed-strings'),
                typeSpeed: 5,
                backDelay: 0,
                loop: false,
    ...
    if ($('body').hasClass('blockchain-page')) {
        ...
        Highcharts.chart('container', {
            ...
            title: {
                text: 'Венчурные инвестиции в блокчейн-проекты в 2016 поквартально'
            },
            subtitle: {
                text: ''
            },
